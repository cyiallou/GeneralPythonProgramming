'''
Password Validator is a program that validates passwords
to match specific rules.
...
2) Pass in a list of passwords: python3 script_name.py word1[\'F wor\'d2]@ abc
